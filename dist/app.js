...
var _1 = require(".");
var returnUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, useremail_1;
    return __generator(this, function (_b) {
        try {
            _a = req.body, email = _a.email, useremail_1 = _a.useremail;
            _1.prisma.user
                .findFirst({
                where: { email: email },
            })
